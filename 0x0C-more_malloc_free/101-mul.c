 ...
 * description: if there is insufficient space, exit with status 98
...
/**
 * get_digit - converts a char to a corresponding integer
 * @c: character to be converted
 * description: if c is a non-digit, exit with status 98
 ...
 * @digit: single digit
 * @zeroes: numbers leading zeroes
 * description: if mult contains a non-digit, exit with value of 98
 */
void get_prod(char *prod, char *mult, int digit, int zeroes)
{
 ...
 * @argc: array of pointers passed to the args
 * description: if the number of args is incorrect, eist with value 98
 * Return: 0
 */
